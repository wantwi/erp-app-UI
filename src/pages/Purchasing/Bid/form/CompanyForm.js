        ...
        >
            <div className="modal-header">
                <h5 className="modal-title" id="staticBackdropLabel">
                    {rowInfo?.id ? `Edit Transaction No. - ${rowInfo?.id}` : "Add Bid"}
                </h5>
                <div>
                ...
                <div className="modal-body">
                    <div className="row mb-3">
                        <div className="col col-md-3">
                            <div >
                                <label className="form-label">Quotation Date<i className="text-danger">*</i></label>
                        ...
                        <div className="col col-md-4">
                            <label className="form-label">Vendor <i className="text-danger"></i></label>
                            <Controller
                    ...
                    <div className="row mb-3">
                        <div className="col col-md-3">
                            ...
                            <div >
                                <label className="form-label">Base On <i className="text-danger"></i></label>
                                <Controller
                                    name={`documentNumber`}
                                    control={control}
                                    render={({ field }) => (
                            ...
                            <Table className="table table-hover table-bordered table-sm" style={{ fontSize: '0.9em !important' }}>
                                <thead className="table-light">
                                    <tr>
                                        ...
                                        <th className='text-r' >Quoted Price</th>
                                        <th>VAT Type</th>
