...
import FormComponet from "./form/FormComponet";
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Fixed Asset" breadcrumbItem="Capitalisation" />
          ...
          <Card>
           ...
           {/* Modal */}
           <FormComponet employees={[]} unitTypes={unitTypes} userInfo={userInfo} setuserInfo={setuserInfo} setShowLoading={setShowLoading} modal_backdrop={modal_backdrop} setmodal_backdrop={setmodal_backdrop} setMinimized={setMinimized}/>
