...
const CompanyForm = ({ refetch,
    ...
    const onPostSuccess = (data) => {
        ...
        console.log({ data })
        showToast("success", data?.status, "Notice")
    }
    ...
    useEffect(() => {
        if (isSuccess) {
            ...
            // showToast("success", "Sales Order Created Successfully", "Notice")
            reset()
            setShowLoading(false)
        }
        if (isLoading) {
        ...
        if (isPutSuccess) {
            // setmodal_backdrop(false)
            // showToast("success", "Sales Order Updated Successfully", "Notice")
            // reset()
            setShowLoading(false)
        }
        if (isPutLoading) {
            ...
            >
                <div className="modal-header">
                    <h5 className="modal-title" id="staticBackdropLabel">
                        {rowInfo?.id ? `Edit Transaction No. - ${rowInfo?.number}` : "Add Sales Order"}
                    </h5>
                    <div>
                    ...
                    <div className="modal-body">
                        <div className="row mb-3">
                            ...
                            <div className="col col-md-3 offset-md-4">
                                ...
                                <div >
                                    <label className="form-label">Order Number <i className="text-danger"></i></label>
                                    <Controller
                                        name={`documentNumber`}
                                        control={control}
                                        render={({ field }) => (
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col col-md-2 offset-md-1">
                            ...
                            <div hidden className="col col-md-2">
                                    ...
                                    <tbody className='tbody' id="cost_area_TableBody">
                                        {
                                            fields.map((field, index) => (
                                                ...
                                                <tr key={field?.id}>
                                                    ...
                                                    <td style={{ textAlign: "center", minWidth: 80 }} hidden>
                                                        <UncontrolledDropdown>
                                                            <DropdownToggle
                                                                href="#"
                                                                className="card-drop"
