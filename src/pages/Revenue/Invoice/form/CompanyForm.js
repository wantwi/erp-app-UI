...
const CompanyForm = ({ refetch, BusinessPartners, items, rowInfo, setRowInfo, setShowLoading, currenciesList, modal_backdrop, setmodal_backdrop, setMinimized }) => {
    ...
    useEffect(() => {
        if (isSuccess) {
            ...
            showToast("success", "Invoice Created Successfully", "Notice")
            reset()
            setShowLoading(false)
        }
        if (isLoading) {
        ...
        if (isPutSuccess) {
            // setmodal_backdrop(false)
            showToast("success", "Invoice Updated Successfully", "Notice")
            // reset()
            setShowLoading(false)
        }
        if (isPutLoading) {
        ...
        >
            <div className="modal-header">
                <h5 className="modal-title" id="staticBackdropLabel">
                    {rowInfo?.id ? `Edit Transaction No. - ${rowInfo?.id}` : "Add Invoice"}
                </h5>
                <div>
                ...
                <div className="modal-body">
                    <div className="row mb-3">
                        <div className="col col-md-4">
                            <div >
                                <label className="form-label">Sales Order ID <i className="text-danger"></i></label>
                                <Controller
                                    name={`salesOrderId`}
                                    control={control}
                                    render={({ field }) => (
                        ...
                        <div className="col col-md-3 offset-md-3">
                            ...
                            <div >
                                <label className="form-label">Invoice Number <i className="text-danger"></i></label>
                                <Controller
                                    name={`documentNumber`}
                                    control={control}
                                    render={({ field }) => (
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col col-md-4">
                            <div >
                                <label className="form-label">Invoice Date <i className="text-danger">*</i></label>
                        ...
                        <div className="col col-md-4">
                            <label className="form-label">Customer Code <i className="text-danger"></i></label>
                            <Controller
                                name={`customerCode`}
                                control={control}
                                render={({ field }) => (
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col col-md-6">
                            ...
                            <label className="form-label">Customer Name<i className="text-danger"></i></label>
                            <Controller
                                name={`customerName`}
                                control={control}
                                render={({ field }) => (
                        ...
                        <div className="col col-md-6">
                            ...
                            <label className="form-label">Billing Address<i className="text-danger"></i></label>
                            <Controller
                                name={`billingAddress`}
                                control={control}
                                render={({ field }) => (
                            ...
                            <Table className="table table-hover table-bordered table-sm" style={{ fontSize: '0.9em !important' }}>
                                <thead className="table-light">
                                    <tr>
                                        <th>#</th>
                                        <th>Item</th>
                                        <th hidden style={{ width: 100 }} >Instock Qty.</th>
