...
function BusinessPartnerGroups() {
    ...
    const { mutate, isLoading: isDelectLoading } = useDelete(`${process.env.REACT_APP_ADMIN_URL}/SalesDeliveries/${selectedRow?.id}`, "sales-deliveries", onDeleteSuccess, onDeletError)
    ...
    const { refetch: refetchGetById, isSuccess: isGetByIdSuccess } = useGetById(`${process.env.REACT_APP_ADMIN_URL}/SalesDeliveries/${selectedRow?.id}`, 'sales-deliveries', selectedRow?.id, onGetByIdSuccess)
    ...
    //meta title
    document.title = "Biz-360 ERP | Sales Quotation";
    ...
    const { refetch, data: SalesDeliveries = [] } = useGetQuery(
        `${process.env.REACT_APP_ADMIN_URL}/SalesDeliveries`,
        ["sales-deliveries"]
    )
        ...
        <> {
            ...
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Financials" breadcrumbItem="Sales Delivery" />
