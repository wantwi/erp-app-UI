...
import { Col, Modal, Nav, CardText, NavItem, NavLink, Row, TabContent, Form, TabPane, Table, Alert, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap';
        ...
        >
            <div className="modal-header">
                <h5 className="modal-title" id="staticBackdropLabel">
                    {rowInfo?.id ? `Edit Transaction No. - ${rowInfo?.id}` : "Add Sale Order"}
                </h5>
                <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="modal-body">
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col col-md-3 offset-md-1" hidden>
                ...
                <div className="modal-footer">
                    ...
                    <button type="submit" className="btn btn-sm  btn-info"><i className="fas fa-save me-2"></i>{"Save as Draft"}</button>
                    <button type="submit" className="btn btn-sm  btn-primary"><i className="fas fa-save me-2"></i>{"Deliver"}</button>
