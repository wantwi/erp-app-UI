...
const appMenus = menus.flatMap(x => (x?.children))
        ...
        <div className="navbar-header">
          <div className="d-flex">
            ...
            <form className="app-search d-none d-lg-block">
              <div className="position-relative">
                <AsyncTypeahead
                  onInputChange={(text) => fromRef.current = text}
                  ...
                  selected={""}
                  renderMenuItemChildren={(option, props) => (<div>
                    <p>{option?.menu}</p>
                  ...
                  caseSensitive={false}
                  clearButton={true}
                  style={{ width: 350, marginLeft: 7, fontSize: 14 }}
                />
                <span className="bx bx-search-alt" />
                {/* <input
                  type="text"
                  className="form-control"
                  placeholder={props.t("Search") + "...AAAA"}
                />
                <span className="bx bx-search-alt" /> */}
              </div>
            </form>
          ...
          <div className="d-flex">
            ...
            <div className="dropdown d-none d-lg-inline-block ms-1">
              ...
              >
                {!isFullscreen ? (<i className="bx bx-expand" />) : (<i className="bx bx-collapse" />)}
              </button>
            </div>
